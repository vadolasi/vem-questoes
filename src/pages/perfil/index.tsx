...
export default function Home() {
  ...
  const updatePassword = async () => {
    const { error } = await executeUpdatePassword({ oldPassword: password, newPassword })
    ...
    if (newPassword !== "") {
      toast.promise(
        updatePassword(),
        {
          ...
          error: "Ocorreu um erro ao atualizar a senha, verifique se você digitou sua senha atual corretamente",
    ...
    <Container>
     ...
     <Content>
      ...
      <Form>
        <Avatar>
        <Image
          src={data?.me?.photoUrl || "https://static.vecteezy.com/system/resources/previews/008/442/086/original/illustration-of-human-icon-user-symbol-icon-modern-design-on-blank-background-free-vector.jpg"}
          width={100}
          height={100}
          alt="Foto do usuário"
        />
